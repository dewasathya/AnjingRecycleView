...
public class GridDogsAdapter extends RecyclerView.Adapter<GridDogsAdapter.GridViewHolder> {
    ...
    public GridDogsAdapter(Context context) {
    ...
    public GridViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_grid_dogs, parent, false);
    ...
    public void onBindViewHolder(@NonNull GridViewHolder holder, int position) {
        Glide.with(context)
                .load(getListDogs().get(position).getPhoto())
